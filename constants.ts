...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Learning', path: '/learning', icon: <AcademicCapIcon className="w-5 h-5 mr-2" /> }, // Courses & Certificates
  { label: 'Writings', path: '/writings', icon: <DocumentTextIcon className="w-5 h-5 mr-2" /> }, // Blog & Whitepapers
