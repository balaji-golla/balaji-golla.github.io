...
export const GEMINI_API_KEY_ERROR_MESSAGE = "API Key for Gemini not configured. Please set the API_KEY environment variable.";
export const GEMINI_FETCH_NEWS_ERROR_MESSAGE = "Could not fetch tech news at the moment. Please try again later.";
